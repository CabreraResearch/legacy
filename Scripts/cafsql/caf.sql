...
select w.businessunitid,
  ...
  --Chemicals (this won't work for PnG)
create or replace view chemicals_view as
(select v.vendorid, p.packageid, p.productno, m."AQUEOUS_SOLUBILITY",m."BOILING_POINT",m."CASNO",m."COLOR",m."COMPRESSED_GAS",m."CREATIONDATE",m."CREATIONSITEID",m."DELETED","DOT_CODE",m."EXPIREINTERVAL",m."EXPIREINTERVALUNITS",m."EXPOSURE_LIMITS",m."FIRECODE",m."FLASH_POINT",m."FORMULA",m."HAZARDS",m."HEALTHCODE",m."INVENTORYREQUIRED",m."KEYWORDS",m."LOB_TYPE",m."MANUFACTURER",m."MATERIAL_FINISH",m."MATERIAL_SIZEVOL",m."MATERIAL_TYPE",m."MATERIAL_USE",m."MATERIALID",m."MATERIALNAME",m."MATERIALSUBCLASSID",m."MELTING_POINT",m."MODEL",m."MOLECULAR_WEIGHT",m."OTHERREFERENCENO",m."PH",m."PHYSICAL_DESCRIPTION",m."PHYSICAL_STATE",m."PPE",m."REACTIVECODE",m."REVIEWSTATUSCHANGEDATE",m."REVIEWSTATUSNAME",m."SPEC_NO",m."SPECIFIC_CODE",m."SPECIFIC_GRAVITY",m."SPECIFICCODE",m."VAPOR_DENSITY",m."VAPOR_PRESSURE",m."KEEPATSTATUS",m."TARGET_ORGANS",m."CREATIONUSERID",m."AUDITFLAG",m."CREATIONWORKUNITID",m."EINECS",m."CONST_UBA_CODE",m."CONST_COLOR_INDEX",m."CONST_SIMPLE_NAME",m."CONST_CHEM_GROUP",m."CONST_INGRED_CLASS",m."CONST_CHEM_REACT",m."LASTUPDATED",m."OPENEXPIREINTERVAL",m."OPENEXPIREINTERVALUNITS",m."CONST_FEMA_NO",m."CONST_COE_NO",m."PRODUCTTYPE",m."PRODUCTBRAND",m."PRODUCTCATEGORY",m."NFPACODE",m."CONST_MAT_FUNCTION",m."HAS_ACTIVITY",m."REFNO",m."TYPE",m."SPECIES",m."VARIETY",m."GOI",m."TRANSGENIC",m."VECTORS",m."BIOSAFETY",m."CONST_MAT_ORIGIN",m."REVIEWSTATUSTYPE",m."STORAGE_CONDITIONS",m."PENDINGUPDATE",m."ISTIER2",m."MATERIALVARIETYID",m."NONHAZARDOUS3E",m."ASSETCREATIONNAME",m."LASTMERGEID",m."LASTMERGENAME",m."NBTUPTODATE" from materials m
