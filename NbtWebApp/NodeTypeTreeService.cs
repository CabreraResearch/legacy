            ...
            try
            {
                    ...
                    contextDictionary.ContainsKey( "Mode" ) && contextDictionary["Mode"] != null )
                {
                    ...
                    if( Mode == NbtDesignMode.Inspection )
                    {
                        ...
                        NodeTypeTree.ObjectClassIdsToInclude = _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.InspectionDesignClass ).ObjectClassId.ToString();
