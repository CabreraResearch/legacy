...
(function _treelIIFE() {
    ...
    /**
     * Private class representing the construnction of a tree. It returns a Csw2.tree.tree instance with collections for adding listeners.
    ...
    */
     ...
     * @param treeDef.store {Csw2.treesStores.store} A store to provide data to the tree
