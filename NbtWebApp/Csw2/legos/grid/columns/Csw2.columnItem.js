/* global Csw2:true, window:true, Ext:true */
...
(function _columnItemIIFE(){
    ...
    */
    ...
    Csw2.instanceOf.lift('ColumnItem', ColumnItem);
     ...
     * @param onHandler {Function} Method to fire in response to action column click
    */
    Csw2.grids.columns.lift('columnItem', function (icon, tooltip, onGetClass, onHandler){
