...
(function _treelIIFE() {
    ...
    */
    var windowProperties = Csw2.object();
    ...
    Csw2.constant(Csw2.okna, 'properties', windowProperties);

    /**
     * Private class representing the construnction of a window (okno). It returns a Csw2.okna.okno instance with collections for adding listeners.
     ...
     * @param store {Csw2.stores.store} A store to provide data to the window (okno)
    ...
    */
    ...
    Csw2.instanceOf.lift('Okno', Okno);
     ...
     * @param windowDef.store {Csw2.trees.stores.store} A store to provide data to the window (okno)
    ...
    */
    Csw2.okna.lift('okno', function(windowDef) {
        if(!(windowDef)) {
