...
(function() {
    ...
    closeSQLTable: function(){
        ...
        Csw2.sql.builder.sqlSelect.removeFieldsByTableId(this.tableId);

        // remove table from sqlTables store inside Csw2.sql.builder.sqlSelect
        Csw2.sql.builder.sqlSelect.removeTableById(this.tableId);
    ...
    initSQLTable: function(){
        ...
        this.resizer.on('resize', function(resizer, width, height, event){
            ...
            for (var i = Csw2.sql.builder.connections.length; i--;) {
                this.connection(Csw2.sql.builder.connections[i]);
            }
        }, this);
