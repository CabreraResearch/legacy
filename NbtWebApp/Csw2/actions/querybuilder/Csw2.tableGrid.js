    ...
    var onInit = function (thisGrid) {
        ...
        var SelModel = Csw2.grids.stores.selectionModel({
            ...
            onSelect: function (selModel, data) {
                ...
                Csw2.sql.builder.sqlSelect.addFieldRecord(data, true);
            },
            onDeselect: function (selModel, data) {
                // remove row from SQLFieldsGrid after deselection
                Csw2.sql.builder.sqlSelect.removeFieldById(data.get('id'));
            }
        });
    ...
    */
    grid.listeners.add(Csw2.grids.constants.listeners.bodyscroll, function () {
        ...
        for (var i = Csw2.sql.builder.connections.length; i--;) {
            sqlTable.connection(Csw2.sql.builder.connections[i]);
        }
    });
    ...
    grid.listeners.add(Csw2.grids.constants.listeners.drop, function (node, data, dropRec, dropPosition) {
            ...
            cm = Ext.create('Ext.menu.Menu', {
                items: [{
                    ...
                    handler: Ext.Function.bind(function () {
                        ...
                        Csw2.sql.builder.sqlSelect.removeJoinById(this.uuid);
                    }, this)
                }, {
                    text: 'Close Menu',
        ...
        if (node.boundView) {
            ...
            dropTable = Csw2.sql.builder.sqlSelect.getTableById(sqlTable1.tableId);
            targetTable = Csw2.sql.builder.sqlSelect.getTableById(sqlTable2.tableId);
            ...
            Csw2.sql.builder.connections.push(connection);
            ...
            Csw2.sql.builder.sqlSelect.addJoin(join);
        }
