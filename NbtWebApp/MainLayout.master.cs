...
namespace ChemSW.Nbt.WebPages
{
    public partial class MainLayout : System.Web.UI.MasterPage
    {
        ...
        public void ChangeMainView( CswViewListTree.ViewType ViewType, Int32 Pk )
        {
            switch( ViewType )
            {
                ...
                case CswViewListTree.ViewType.Report:
                    ...
                    break;
                default:
                    throw new CswDniException( "Invalid Selection", "MainLayout.master.cs::ChangeMainView() got an invalid ViewType: " + ViewType.ToString() );
		...
		protected void _QuickLaunch_OnSessionViewLinkClick( CswNbtSessionViewId SessionViewId )
        {
		...
		public void setSessionViewId( CswNbtSessionViewId ViewId, bool ForceReload ) { Master.setSessionViewId( ViewId, ForceReload ); }
		public void setSessionViewId( CswNbtSessionViewId ViewId ) { Master.setSessionViewId( ViewId ); }
