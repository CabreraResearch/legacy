...
namespace ChemSW.Nbt.WebServices
{
    ...
    public class wsNBT : WebService
    {
        ...
        [WebMethod( EnableSession = false )]
        [ScriptMethod( ResponseFormat = ResponseFormat.Json )]
        public string saveMaterial( string NodeTypeId, string SupplierId, string Suppliername, string Tradename, string PartNo, string NodeId, string IsConstituent )
        {
            JObject ReturnVal = new JObject();
            CswEnumAuthenticationStatus AuthenticationStatus = CswEnumAuthenticationStatus.Unknown;
            try
            {
                ...
                ReturnVal = ws.saveMaterial( CswConvert.ToInt32( NodeTypeId ), SupplierId, Suppliername, Tradename, PartNo, NodeId, CswConvert.ToBoolean( IsConstituent ) );
