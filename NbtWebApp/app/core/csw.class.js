...
(function () {
    ...
    */
    Csw.register('Class', function(name, inheritsFrom, callBack) {
        ...
        obj[name] = function() {
            try {
                ...
                Csw.errors.ClassInheritanceError('Csw failed to execute all or part of its callback routine for Class: ' + name);
            }
        };
        if(inheritsFrom) {
