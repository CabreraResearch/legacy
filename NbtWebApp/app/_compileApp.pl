...
`java -jar "$dir\\..\\..\\..\\ThirdParty\\ClosureCompiler\\compiler.jar" $param --language_in=ECMASCRIPT5 --create_source_map $dir/app/app.js.map --source_map_format=V3 --js_output_file $destfile`;
