...
$param .= extractPath("$dir\\app\\fieldtypes_dep");
...
$param .= extractPath("$dir\\app\\props");
...
`java -jar "$dir\\..\\..\\..\\ThirdParty\\ClosureCompiler\\compiler.jar" $param  --create_source_map $dir/app/app.js.map --source_map_format=V3 --js_output_file $destfile`;
...
$vsparam .= extractContent("$dir\\app\\fieldtypes_dep");
...
$vsparam .= extractContent("$dir\\app\\props");
