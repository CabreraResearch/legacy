...
(function ($) {
    ...
    var methods = {
        ...
        ViewEditorFilterDialog: function (options) {
            'use strict';
            var o = {
                relationship: {},
                viewJson: '',
            ...
            var div = Csw.literals.div({ name: 'searchdialog_div' });
            div.span({ text: 'How do you want to filter your results?' });
            div.br({ number: 2 });
            var tbl = div.table({
                cellspacing: 4,
                cellpadding: 4
            });
            tbl.cell(1, 1).span({ text: o.relationship.TextLabel });
            var propSelect = tbl.cell(1, 2).select({
                name: 'vieweditor_propfilter_select',
                onChange: function () {
                    if (propSelect.selectedText() !== 'Select...') {
                        o.selectedProp = properties[propSelect.selectedVal()];

                        o.currentFilter = Csw.nbt.viewPropFilter({
                            name: 'vieweditor_filter_' + o.selectedProp.ArbitraryId,
                            parent: filterTbl,
                            viewJson: o.viewJson,
                            proparbitraryid: o.selectedProp.ArbitraryId,
                            propname: o.selectedProp.PropName,
            ...
            div.button({
                ...
                onClick: function () {
                    var filterData = o.currentFilter.getFilterJson();
                    var ajaxData = {
                        CurrentView: o.view,
                        Property: o.selectedProp,
            ...
            Csw.ajaxWcf.post({
                ...
                success: function (response) {
                    ...
                    Csw.iterate(response.Step4.Properties, function (prop) {
                    ...
                    propSelect.addOption({ display: 'Select...', value: '' }, true);
                }
            });

            openDialog(div, 600, 270, o.onClose, 'Edit View Filter');
        }, // BatchOpDialog
