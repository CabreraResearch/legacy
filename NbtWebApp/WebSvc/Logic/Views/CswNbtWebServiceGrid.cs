...
namespace ChemSW.Nbt.WebServices
{
    public class CswNbtWebServiceGrid
    {
        ...
        public JObject runGrid( bool IncludeInQuickLaunch, bool GetAllRowsNow = false, bool IsPropertyGrid = false )
        {
            _View.SaveToCache( IncludeInQuickLaunch );
            ICswNbtTree Tree = _CswNbtResources.Trees.getTreeFromView( _View, false, false, false );
            return _CswNbtGrid.TreeToJson( _View, Tree, IsPropertyGrid: ( IsPropertyGrid || _View.Visibility == NbtViewVisibility.Property ) );
        } // runGrid()
