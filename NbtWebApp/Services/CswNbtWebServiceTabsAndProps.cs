...
namespace ChemSW.Nbt.WebServices
{
    public class CswNbtWebServiceTabsAndProps
    {
        ...
        {
            return _TabsPropsSd.getProps( NodeId, NodeKey, TabId, NodeTypeId, Date, filterToPropId );
        } // getProps()
        ...
        {
            return _TabsPropsSd.makePropJson( NodeId, TabId, Prop, PropWrapper, Row, Column );
        } // makePropJson()
