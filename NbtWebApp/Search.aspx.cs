    ...
    public partial class Search : System.Web.UI.Page
    {
        ...
        void _DeleteButton_Click( object sender, EventArgs e )
        {
            try
            {
                ...
                {
					CswNbtView DoomedView = Master.CswNbtResources.ViewSelect.restoreView( new CswNbtViewId( CswConvert.ToInt32( _LoadDropDown.SelectedValue ) ) );
        ...
        void _LoadButton_Click( object sender, EventArgs e )
        {
            try
            {
                if( CswTools.IsInteger( _LoadDropDown.SelectedValue ) )
                {
					Master.setViewId( new CswNbtViewId( CswConvert.ToInt32( _LoadDropDown.SelectedValue ) ) );
