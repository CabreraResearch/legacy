...
; (function ($) { /// <param name="$" type="jQuery" />
	$.fn.CswSearch = function (options) {
		...
		function renderNodeTypeSearchContent()
		{
			...
			o.$nodeTypesSelect = $(xmlToString(o.nodeTypesData.children('select')))
		    ...
		    var $propSelect = $propSelectCell.CswSelect('init', {ID: propSelectId,
		                                                         ...
		                                                         onChange: function() {
									                                ...
									                                var r = {
										                                ...
										                                selectedSubfieldVal: '',
										                                selectedFilterVal: '',
										                                selectedPropData: findObject(o.propsData.propertyfilters.property, 'viewbuilderpropid', thisPropId)
									                                };
									                                $.extend(o,r);
									                                o.$searchTable.CswViewPropFilter('init', {
												                                ID: o.ID,
			...
			o.selectedPropData = findObject(o.propsData.propertyfilters.property, 'viewbuilderpropid', o.propertyid);
				...
				'success': function(data) { 
					...
					switch(o.searchtype)
					{
						case 'nodetypesearch':
						{
							...
							o.propsData = data.viewbuilderprops;
							renderNodeTypeSearchContent();
							break;
						}
						case 'viewsearch':
...
//													   .CswAttrDom('fieldtype');
					    var selectedProp = findObject(o.propsData.propertyfilters, 'viewbuildpropid', viewbuildpropid);
