    ...
    (function() {
        var o = {
            ...
            gridOpts: {
                ...
                //toppager: false,
                width: '600px',
                //24004: Disable the pager and roll our own
    ...
    function makeGrid(o) {
        ...
        if (o.hasPager) {
            $gridTable.jqGrid(o.gridOpts)
                      ...
                      .jqGrid('navButtonToAdd', '#' + gridPagedId, prevButton)
                      .jqGrid('navSeparatorAdd', '#' + gridPagedId, spacer)
                      .jqGrid('navButtonToAdd', '#' + gridPagedId, nextButton);
        } else {
            $gridTable.jqGrid(o.gridOpts);    
        }
