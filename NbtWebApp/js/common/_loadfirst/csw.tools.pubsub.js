...
(function () {
    ...
    Csw.register('subscribe', subscribe);
    Csw.subscribe = Csw.subscribe || subscribe;
    ...
    Csw.register('unsubscribe', unsubscribe);
    Csw.unsubscribe = Csw.unsubscribe || unsubscribe;
    ...
    Csw.register('publish', publish);
    Csw.publish = Csw.publish || publish;
