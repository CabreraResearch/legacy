...
jQuery.extend(jQuery.validator.messages, {
  ...
  maxlength: jQuery.format("{0} æ–‡å­—ä»¥å†…ã§å…¥åŠ›ã—ã¦ãã ã•ã„ã€‚"),
  minlength: jQuery.format("{0} æ–‡å­—ä»¥ä¸Šã§å…¥åŠ›ã—ã¦ãã ã•ã„ã€‚"),
  rangelength: jQuery.format("{0} æ–‡å­—ã‹ã‚‰ {1} æ–‡å­—ã¾ã§ã®å€¤ã‚’å…¥åŠ›ã—ã¦ãã ã•ã„ã€‚"),
  range: jQuery.format("{0} ã‹ã‚‰ {1} ã¾ã§ã®å€¤ã‚’å…¥åŠ›ã—ã¦ãã ã•ã„ã€‚"),
  max: jQuery.format("{0} ä»¥ä¸‹ã®å€¤ã‚’å…¥åŠ›ã—ã¦ãã ã•ã„ã€‚"),
  min: jQuery.format("{1} ä»¥ä¸Šã®å€¤ã‚’å…¥åŠ›ã—ã¦ãã ã•ã„ã€‚")
});