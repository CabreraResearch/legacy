    ...
    $.fn.hyjack_select = function (settings) {
        try {
            ...
            settings = jQuery.extend({
                ...
                ddImage: 'jquery/jquery.hyjack.select-1.1.2/arrow_down.png', 

                ddCancel: 'jquery/jquery.hyjack.select-1.1.2/cancel.png',
		...
		function _width(hj){	
			...
			hj.options.width(hj.selector.width() + 40);
			hj.container.width(hj.selector.width() + 40);			
		}
