...
;(function($) {
    ...
    $.fn.doChangePage = function(p,options) {
        var o = {
            transition: 'fade'
            //reverse: false,
            //changeHash: true,
        ...
        if (!isNullOrEmpty($div)) {
            ...
            //if (id !== $div.CswAttrDom('id')) ret = 
            $('body').children('div').each(function() {
                var $this = $(this);
                $this.addClass('csw_hidden')
                     .removeClass('csw_active')
                     .css('display','none')            
                     .hide();
            });
            $div.removeClass('csw_hidden')
                .addClass('csw_active')
                .css('display','')
                .show()
                .click();
            //$.mobile.changePage($div, o);
        }
        return ret;
    };
    ...
    $.fn.CswMobileNoJqm = function(options) {
        /// <summary>
...
//                    });
        ...
        function _processViewXml(params) {
            ...
            var $content = $retDiv.find('div[data-role="content"]').empty();
...
//                Html += '<span id="' + makeSafeId({ prefix: id, ID: 'unansweredcnt' }) + '" class="ui-li-count">' + UnansweredCnt + '</span>';
        ...
        function _addToDivHeaderText($div, text) {
            $div.find('div[data-role="header"] h1').append($('<p style="color: yellow; white-space: normal;">' + text + '</p>'));
            //$.mobile.loadPage($div);
            return $div;
        }
