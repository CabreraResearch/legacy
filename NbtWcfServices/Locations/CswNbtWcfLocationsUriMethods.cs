        ...
        public CswNbtWcfLocationsResponse list( bool IsMobile = true )
        {
            ...
            try
            {
                ...
                if( Ret.SessionAuthenticationStatus.AuthenticationStatus == AuthenticationStatus.Authenticated.ToString() )
                {
                    ...
                    if( LocationCount > 0 )
                    {
                        CswNbtMetaDataObjectClass LocationsOc = _CswNbtWcfSessionResources.CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.LocationClass );
