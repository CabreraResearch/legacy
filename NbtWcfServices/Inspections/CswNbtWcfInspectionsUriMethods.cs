...
namespace NbtWebAppServices.WebServices
{
    ...
    public class CswNbtWcfInspectionsUriMethods
    {
        ...
        public CswNbtWcfInspectionsResponseWithDesigns byDateRange( string StartingDate, string EndingDate )
        {
            ...
            Start = Start.Date;
            End = End.Date;
            WcfInspectionsGet.addSystemViewPropFilter( CswNbtMetaDataObjectClassName.NbtObjectClass.InspectionDesignClass, CswNbtObjClassInspectionDesign.PropertyName.Date, Start.ToShortDateString(), CswNbtPropFilterSql.PropertyFilterMode.GreaterThanOrEquals );
            WcfInspectionsGet.addSystemViewPropFilter( CswNbtMetaDataObjectClassName.NbtObjectClass.InspectionDesignClass, CswNbtObjClassInspectionDesign.PropertyName.Date, End.ToShortDateString(), CswNbtPropFilterSql.PropertyFilterMode.LessThanOrEquals );
        ...
        public CswNbtWcfInspectionsResponseWithDesigns byLocation( string LocationName )
        {
            ...
            WcfInspectionsGet.addSystemViewPropFilter( CswNbtMetaDataObjectClassName.NbtObjectClass.InspectionDesignClass, CswNbtObjClassInspectionDesign.PropertyName.Location, LocationName, CswNbtPropFilterSql.PropertyFilterMode.Begins );
            return WcfInspectionsGet.finalize();
        } // get()
