...
namespace ChemSW.NbtWebControls
{
    public class CswNodeTypeDropDown : DropDownList
    {
        ...
        public delegate void SelectedNodeTypeChangedHandler( RelatedIdType SelectedType, Int32 SelectedValue );
        ...
        {
            RelatedIdType SelectedType = RelatedIdType.Unknown;
            Int32 SelectedVal = Int32.MinValue;

            if( this.SelectedValue.StartsWith( _NodeTypePrefix ) )
            {
                SelectedType = RelatedIdType.NodeTypeId;
            ...
            {
                SelectedType = RelatedIdType.ObjectClassId;
