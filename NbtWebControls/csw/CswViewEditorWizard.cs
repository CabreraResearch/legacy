...
//                if( values[_GroupByDropDown.UniqueID] != null && values[_GroupByDropDown.UniqueID].ToString() != string.Empty )
//                {
...
//                                CswNbtViewRelationship R = new CswNbtViewRelationship( _CswNbtResources, _View, LatestNodeType.FirstVersionNodeType );
...
//                        {
//                            // This is purposefully not the typical way of creating CswNbtViewRelationships.
//                            CswNbtViewRelationship R = new CswNbtViewRelationship( _CswNbtResources, _View, ObjectClass );
...
//            _SelectFiltersStepSubTable.addControl( 1, 0, _Filter );
...
//                        _View.Root.ViewMode = (NbtViewRenderingMode) Enum.Parse( typeof( NbtViewRenderingMode ), _ModeDropDown.SelectedValue );
...
//                {
//                    CswNbtViewRelationship NewRelationship = new CswNbtViewRelationship( _CswNbtResources, _View, _NextOptions.SelectedValue );
...
//                    RelationshipsSelectedViewNode.AddChild( NewRelationship );
