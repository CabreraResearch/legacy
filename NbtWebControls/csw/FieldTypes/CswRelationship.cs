        ...
        private void CswRelationship_DataBinding( object sender, EventArgs e )
        {
            try
            {
                ...
                if( Prop != null )
                {
                    ...
                    // BZ 10216
                    if( Prop.AsRelationship.TargetType == CswEnumNbtViewRelatedIdType.NodeTypeId && !ReadOnly )
                        ReadOnly = !( _CswNbtResources.Permit.canNodeType( CswEnumNbtNodeTypePermission.View, _CswNbtResources.MetaData.getNodeType( Prop.AsRelationship.TargetId ) ) );
        ...
        protected override void OnPreRender( EventArgs e )
        {
            try
            {
                ...
                if( _EditMode != CswEnumNbtNodeEditMode.Add &&
                    ...
                    !ReadOnly &&
                    Prop.AsRelationship.TargetType == CswEnumNbtViewRelatedIdType.NodeTypeId &&
                    _CswNbtResources.Permit.canNodeType( CswEnumNbtNodeTypePermission.Create, _CswNbtResources.MetaData.getNodeType( Prop.AsRelationship.TargetId ) ) )
                {
