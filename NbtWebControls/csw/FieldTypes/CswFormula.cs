...
namespace ChemSW.NbtWebControls.FieldTypes
{
    ...
    /// Fieldtype: Text
    /// </summary>
    public class CswFormula : CswFieldTypeWebControl, INamingContainer
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public CswFormula( CswNbtResources CswNbtResources, CswNbtMetaDataNodeTypeProp CswNbtMetaDataNodeTypeProp, CswEnumNbtNodeEditMode EditMode )
        ...
        private void CswText_DataBinding( object sender, EventArgs e )
        {
            ...
            if( Prop != null )
            {
                Text = Prop.AsFormula.Text;
                _TextBox.Columns = Prop.AsFormula.Size;
            }
        }
