        ...
        public class LayoutComponent
        {
            ...
            public LayoutComponent( Int32 inLayoutComponentId, Int32 inDisplayRow, Int32 inDisplayColumn, WebControl inLabelControl, WebControl inValueControl, bool inAllowDelete )
            {
                ...
                if( inDisplayRow < 0 || inDisplayRow > 200 )
                    throw new CswDniException( CswEnumErrorType.Error, "Invalid Row", "LayoutComponent got an invalid row:" + inDisplayRow.ToString() );
                if( inDisplayColumn < 0 || inDisplayColumn > 200 )
                    throw new CswDniException( CswEnumErrorType.Error, "Invalid Column", "LayoutComponent got an invalid column:" + inDisplayColumn.ToString() );
