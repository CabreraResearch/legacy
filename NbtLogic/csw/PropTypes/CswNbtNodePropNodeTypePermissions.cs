...
namespace ChemSW.Nbt.PropTypes
{
    ...
    public class CswNbtNodePropNodeTypePermissions : CswNbtNodeProp
    {

        public CswNbtNodePropNodeTypePermissions( CswNbtResources CswNbtResources, CswNbtNodePropData CswNbtNodePropData, CswNbtMetaDataNodeTypeProp CswNbtMetaDataNodeTypeProp )
            : base( CswNbtResources, CswNbtNodePropData, CswNbtMetaDataNodeTypeProp )
        {
            if( _CswNbtMetaDataNodeTypeProp.FieldType.FieldType != CswNbtMetaDataFieldType.NbtFieldType.NodeTypePermissions )
            {
                throw ( new CswDniException( ErrorType.Error, "A data consistency problem occurred",
                                            "CswNbtNodePropNodeTypePermissions() was created on a property with fieldtype: " + _CswNbtMetaDataNodeTypeProp.FieldType.FieldType ) );
            }

            _ValueSubField = ( (CswNbtFieldTypeRuleNodeTypePermissions) CswNbtMetaDataNodeTypeProp.FieldTypeRule ).ValueSubField;
