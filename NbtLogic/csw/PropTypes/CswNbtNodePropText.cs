    ...
    public class CswNbtNodePropText : CswNbtNodeProp
    {
        ...
        public Int32 MaxLength
        {
            get
            {
                ...
                Int32 Ret = CswConvert.ToInt32( _CswNbtNodePropData[CswEnumNbtPropertyAttributeName.MaximumLength] );
                if( Ret <= 0 )
                {
                    Ret = 255;
                }
        ...
        public string RegEx
        {
            get
            {
                ...
                return _CswNbtNodePropData[CswEnumNbtPropertyAttributeName.ValidationRegex];
            }
        }
        ...
        public string RegExMsg
        {
            get
            {
                ...
                return _CswNbtNodePropData[CswEnumNbtPropertyAttributeName.RegexMessage];
            }
        }
