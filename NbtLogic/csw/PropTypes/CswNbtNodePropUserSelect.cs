...
namespace ChemSW.Nbt.PropTypes
{
    ...
    public class CswNbtNodePropUserSelect : CswNbtNodeProp
    {
            ...
            : base( CswNbtResources, CswNbtNodePropData, CswNbtMetaDataNodeTypeProp, Node )
        {
            ...
            _SubFieldMethods.Add( _SelectedUserIdsSubField.Name, new Tuple<Func<dynamic>, Action<dynamic>>( () => SelectedUserIds, x => SelectedUserIds = new CswCommaDelimitedString( CswConvert.ToString( x ) ) ) );
        }//ctor
