...
namespace ChemSW.Nbt.PropTypes
{
    ...
    public class CswNbtNodePropViewPickList : CswNbtNodeProp
    {
            ...
            : base( CswNbtResources, CswNbtNodePropData, CswNbtMetaDataNodeTypeProp, Node )
        {
            ...
            _SubFieldMethods.Add( _SelectedViewIdsSubField.Name, new Tuple<Func<dynamic>, Action<dynamic>>( () => SelectedViewIds, x => SelectedViewIds = new CswCommaDelimitedString( CswConvert.ToString( x ) ) ) );
            _SubFieldMethods.Add( _CachedViewNameSubField.Name, new Tuple<Func<dynamic>, Action<dynamic>>( () => CachedViewNames, x => CachedViewNames = new CswCommaDelimitedString( CswConvert.ToString( x ) ) ) );
        }
