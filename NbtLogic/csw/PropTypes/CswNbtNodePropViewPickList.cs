...
namespace ChemSW.Nbt.PropTypes
{
    ...
    public class CswNbtNodePropViewPickList : CswNbtNodeProp
    {
            ...
            : base( CswNbtResources, CswNbtNodePropData, CswNbtMetaDataNodeTypeProp, Node )
        {
            ...
            _SubFieldMethods.Add( _SelectedViewIdsSubField, new Tuple<Func<dynamic>, Action<dynamic>>( () => SelectedViewIds, x => SelectedViewIds = new CswCommaDelimitedString( CswConvert.ToString( x ) ) ) );
            _SubFieldMethods.Add( _CachedViewNameSubField, new Tuple<Func<dynamic>, Action<dynamic>>( () => CachedViewNames, x => CachedViewNames = new CswCommaDelimitedString( CswConvert.ToString( x ) ) ) );
        }
