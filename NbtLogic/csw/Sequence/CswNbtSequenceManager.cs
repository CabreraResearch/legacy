    ...
    public class CswNbtSequenceManager
    {
        ...
        public Int32 makeSequence( CswSequenceName SequenceName, string Prepend, string Append, Int32 Pad, Int32 InitialValueIn )
        {
            if(SequenceName.DisplayName == string.Empty)
				throw ( new CswDniException( CswEnumErrorType.Warning, "Sequence Name is Required", "To create a new Sequence, the Sequence Name is Required" ) );

            if( doesSequenceExist( SequenceName ) )
				throw ( new CswDniException( CswEnumErrorType.Warning, "Sequence Error", "A sequence named " + SequenceName.DisplayName + " is already defined" ) );
        ...
        public void editSequence( Int32 SequenceId, CswSequenceName NewSequenceName, string Prepend, string Append, Int32 Pad )
        {
            ...
            {
				throw ( new CswDniException( CswEnumErrorType.Error, "Sequence Error", "Sequence with SequenceId " + SequenceId.ToString() + " is not defined" ) );
            }
        ...
        public void assignSequence( CswSequenceName SequenceName, Int32 NodeTypePropId )
        {
            ...
            {
				throw new CswDniException( CswEnumErrorType.Error, "Invalid Sequence", "User attempted to assign a non-existant sequence name: " + SequenceName.DisplayName );
            }
        }//assignSequence()
