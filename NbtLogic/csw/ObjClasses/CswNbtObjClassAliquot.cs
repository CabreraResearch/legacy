...
namespace ChemSW.Nbt.ObjClasses
{
    public class CswNbtObjClassAliquot : CswNbtObjClass
    {
        ...
        {
            get { return _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.AliquotClass ); }
        }
        ...
        public static implicit operator CswNbtObjClassAliquot( CswNbtNode Node )
        {
            ...
            if( null != Node && _Validate( Node, CswNbtMetaDataObjectClassName.NbtObjectClass.AliquotClass ) )
            {
