...
namespace ChemSW.Nbt.ObjClasses
{
    public class CswNbtObjClassBiological : CswNbtObjClass
    {
        ...
        {
            get { return _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.BiologicalClass ); }
        }
        ...
        public static implicit operator CswNbtObjClassBiological( CswNbtNode Node )
        {
            ...
            if( null != Node && _Validate( Node, CswNbtMetaDataObjectClassName.NbtObjectClass.BiologicalClass ) )
            {
