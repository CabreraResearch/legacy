...
namespace ChemSW.Nbt.ObjClasses
{
    public class CswNbtObjClassInventoryGroup : CswNbtObjClass
    {
        ...
        {
            get { return _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.InventoryGroupClass ); }
        }
        ...
        public static implicit operator CswNbtObjClassInventoryGroup( CswNbtNode Node )
        {
            ...
            if( null != Node && _Validate( Node, CswNbtMetaDataObjectClassName.NbtObjectClass.InventoryGroupClass ) )
            {
