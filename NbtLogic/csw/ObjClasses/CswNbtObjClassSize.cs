...
namespace ChemSW.Nbt.ObjClasses
{
    public class CswNbtObjClassSize : CswNbtObjClass
    {
        ...
        {
            get { return _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.SizeClass ); }
        }
        ...
        public static implicit operator CswNbtObjClassSize( CswNbtNode Node )
        {
            ...
            if( null != Node && _Validate( Node, CswNbtMetaDataObjectClassName.NbtObjectClass.SizeClass ) )
            {
        ...
        private bool _isMaterialID( CswPrimaryKey nodeid )
        {
            ...
            isMaterialID = ( null != node && CswNbtMetaDataObjectClassName.NbtObjectClass.MaterialClass == node.getObjectClass().ObjectClass );
            return isMaterialID;
        }
