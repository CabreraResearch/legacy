...
namespace ChemSW.Nbt.ObjClasses
{
    public class CswNbtObjClassInventoryLevel : CswNbtObjClass
    {
        ...
        public static implicit operator CswNbtObjClassInventoryLevel( CswNbtNode Node )
        {
            ...
            if( null != Node && _Validate( Node, CswNbtMetaDataObjectClassName.NbtObjectClass.InventoryLevelClass ) )
            {
        ...
        {
            get { return _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.InventoryLevelClass ); }
        }
