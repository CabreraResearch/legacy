...
namespace ChemSW.Nbt.ObjClasses
{
    public class CswNbtObjClassContainer : CswNbtObjClass
    {
        ...
        {
            get { return _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.ContainerClass ); }
        }
        ...
        public static implicit operator CswNbtObjClassContainer( CswNbtNode Node )
        {
            ...
            if( null != Node && _Validate( Node, CswNbtMetaDataObjectClassName.NbtObjectClass.ContainerClass ) )
            {
