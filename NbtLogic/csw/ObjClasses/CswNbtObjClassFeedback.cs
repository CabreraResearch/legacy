...
namespace ChemSW.Nbt.ObjClasses
{
    public class CswNbtObjClassFeedback : CswNbtObjClass
    {
        ...
        private void _setDefaultValues()
        {
            ...
            //    {
            //        Action.Text = _CswNbtResources.CurrentNbtUser.Cookies["csw_currentactionname"].Replace( "%20", "%20" );
            //    }
        ...
        {
            _setDefaultValues();
            //Action.setHidden( true, true );
            //SelectedNodeId.setHidden( true, true );
            //View.setHidden( true, true );
            //CurrentViewMode.setHidden( true, true );
