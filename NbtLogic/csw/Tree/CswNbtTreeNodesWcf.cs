...
{
    public class CswNbtTreeNodesWcf
    {
        ...
        public CswNbtTreeNodesWcf( CswNbtTreeKey CswNbtTreeKey, string TreeName, CswNbtResources CswNbtResources, CswNbtNodeCollection CswNbtNodeCollection )
        {
