...
namespace ChemSW.Nbt
{
    ...
    public interface ICswNbtTree
    {
        ...
        /// <summary>
        /// Returns the root TreeNode of the tree
        /// </summary>
        CswNbtTreeNode getRootTreeNode();

        /// <summary>
        /// Returns the current TreeNode of the tree
        /// </summary>
        CswNbtTreeNode getCurrentTreeNode();

        /// <summary>
        /// Returns the current NbtNode of the tree
        /// </summary>
        CswNbtNode getCurrentNode();
        ...
        /// </summary>
        void addProperty( Int32 NodeTypePropId, Int32 ObjectClassPropId, Int32 JctNodePropId, string PropName, string ObjectClassPropName, string Gestalt, CswEnumNbtFieldType FieldType, string Field1, string Field2, Int32 Field1_Fk, double Field1_Numeric, bool Hidden, string Field1_Big );
