...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswNbtSchemaModTrnsctn
    {
        ...
        public void createModuleActionJunction( CswNbtModule Module, CswNbtActionName ActionName )
        {
        ...
        public Int32 getModuleId( CswNbtModule Module )
        {
        ...
        /// </summary>
        public void createModuleObjectClassJunction( CswNbtModule Module, Int32 ObjectClassId )
        {
            Int32 ModuleId = getModuleId( Module );
        ...
        /// </summary>
        public void createModuleNodeTypeJunction( CswNbtModule Module, Int32 NodeTypeId )
        {
            Int32 ModuleId = getModuleId( Module );
