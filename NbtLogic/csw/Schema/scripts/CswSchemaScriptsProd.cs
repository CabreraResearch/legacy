...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswSchemaScriptsProd : ICswSchemaScripts
    {
        ...
        public CswSchemaScriptsProd()
        {
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase27800() ) );                              //01R-050 //01S-017
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase27779() ) );                              //01R-051 //01S-018
