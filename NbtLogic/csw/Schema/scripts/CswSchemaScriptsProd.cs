...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswSchemaScriptsProd : ICswSchemaScripts
    {
        ...
        public CswSchemaScriptsProd()
        {
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02C_CaseXXXXX() ) );                          // 02B-027
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02B_Case29797() ) );                          // 02B-032

            #endregion BUCKEYE

            #region CEDAR

            // e.g. _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02C_CaseXXXXX() ) );            //02B-032  02C-000
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02C_Case29563() ) );                    //02B-036  02C-004
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02C_Case29563B() ) );                   //02B-037  02C-005
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02C_Case29833() ) );                    //02B-038  02C-006
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02C_Case29833B() ) );                   //02B-039  02C-007
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02C_Case29234() ) );                    //02B-040  02C-008
