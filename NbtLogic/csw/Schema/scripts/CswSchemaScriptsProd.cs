...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswSchemaScriptsProd : ICswSchemaScripts
    {
        ...
        public CswSchemaScriptsProd()
        {
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase26714MakeUserManaged() ) );      //01P-67
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase26523() ) );                     //01P-68            
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase25815() ) );                     //01P-69
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase27077() ) );                     //01P-70
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase26550() ) );                     //01P-71
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase27046() ) );                     //01P-72
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase27145() ) );                     //01P-73
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase27147() ) );                     //01P-74
