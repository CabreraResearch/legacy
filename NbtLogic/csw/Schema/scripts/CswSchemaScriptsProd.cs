...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswSchemaScriptsProd : ICswSchemaScripts
    {
        ...
        public CswSchemaScriptsProd() //CswNbtResources CswNbtResources )
        {
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaToCase25538_Part_1() ) );  //44
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaToCase25538_Part_2() ) );  //45
