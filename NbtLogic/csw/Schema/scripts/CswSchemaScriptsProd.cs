...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswSchemaScriptsProd : ICswSchemaScripts
    {
        ...
        public CswSchemaScriptsProd()
        {
            ...
            // e.g. _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCaseXXXXX() ) );           //01W-000
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_01W_Case27923_Save() ) );      //01W-058   01Y-01
