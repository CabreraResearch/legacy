...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswSchemaScriptsProd: ICswSchemaScripts
    {
        ...
        public CswSchemaScriptsProd()
        {
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02F_Case30041_UnitsOfMeasure() ) );     //02E-028 //02F-017
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchema_02F_Case30041_RolesUsers() ) );         //02E-029 //02F-018
            ...
            _addRunBeforeScript( new CswSchemaUpdateDriver( new RunBeforeEveryExecutionOfUpdater_02F_Case30228() ), RunBeforeEveryExecutionOfUpdater_02F_Case30228.Title );
