...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswSchemaScriptsProd : ICswSchemaScripts
    {
        ...
        public CswSchemaScriptsProd()
        {
            ...
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase26094() ) );         //01O-07
            _addVersionedScript( new CswSchemaUpdateDriver( new CswUpdateSchemaCase26094B() ) );         //01O-08
