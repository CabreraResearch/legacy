...
namespace ChemSW.Nbt.Schema
{
    ...
    /// </summary>
    public class RunBeforeEveryExecutionOfUpdater_02D_Case29833: CswUpdateSchemaTo
    {
        ...
        {
            //NOTE - this was migrated from the Cedar schema scripts (29833) because of Case 29499
