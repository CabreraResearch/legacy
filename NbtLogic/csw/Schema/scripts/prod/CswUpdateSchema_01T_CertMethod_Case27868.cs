...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswUpdateSchema_01T_CertMethod_Case27868 : CswUpdateSchemaTo
    {
        ...
        {
            CswNbtMetaDataObjectClass CertMethodTempOc = _CswNbtSchemaModTrnsctn.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.CertMethodTemplateClass );
