...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswUpdateSchemaTo01H28 : ICswUpdateSchemaTo
    {
        ...
        public CswSchemaVersion SchemaVersion { get { return new CswSchemaVersion( 1, 'H', 28 ); } }

        public string Description { get { return ( _CswProdUpdtRsrc.makeTestCaseDescription( SchemaVersion ) ); } }

        public CswUpdateSchemaTo01H28( CswNbtSchemaModTrnsctn CswNbtSchemaModTrnsctn )
        {
