...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswUpdateSchemaTo01M02 : CswUpdateSchemaTo
    {
        ...
        public override void update()
        {
            ...
            _CswNbtSchemaModTrnsctn.addStringColumn( "field_types_subfields", "subfieldname", "name of storage column in jct_node_props", true, true, 20 );
            ...
            _CswNbtSchemaModTrnsctn.addStringColumn( "field_types_subfields", "subfieldalias", "suffix on this propertyname in the view", true, false, 20 );
            #endregion
