...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswUpdateSchema_01T_Case27740 : CswUpdateSchemaTo
    {
        public override void update()
        {
            ...
            _CswNbtSchemaModTrnsctn.MetaData.SetObjectClassPropDefaultValue( viewOCP, CswNbtSubField.SubFieldName.Checked, false );
            ...
            _CswNbtSchemaModTrnsctn.MetaData.SetObjectClassPropDefaultValue( editOCP, CswNbtSubField.SubFieldName.Checked, false );
            ...
            _CswNbtSchemaModTrnsctn.MetaData.SetObjectClassPropDefaultValue( dispenseOCP, CswNbtSubField.SubFieldName.Checked, false );
            ...
            _CswNbtSchemaModTrnsctn.MetaData.SetObjectClassPropDefaultValue( requestOCP, CswNbtSubField.SubFieldName.Checked, false );

            _CswNbtSchemaModTrnsctn.MetaData.SetObjectClassPropDefaultValue( disposeOCP, CswNbtSubField.SubFieldName.Checked, false );

            _CswNbtSchemaModTrnsctn.MetaData.SetObjectClassPropDefaultValue( undisposeOCP, CswNbtSubField.SubFieldName.Checked, false );
