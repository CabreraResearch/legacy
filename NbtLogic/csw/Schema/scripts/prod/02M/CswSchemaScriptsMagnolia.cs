        ...
        public Collection<CswUpdateSchemaTo> _MetaDataScripts()
        {
            return new Collection<CswUpdateSchemaTo>
                ...
                // new CswUpdateMetaData_02M_CISXXXXX(),
                    new CswUpdateMetaData_02M_CIS51852A(),
                    new CswUpdateMetaData_02M_CIS51852B(),
                   ...
                   new CswUpdateMetaData_02M_CIS53381(),
                   new CswUpdateMetaData_02M_CIS52299(),
                   new CswUpdateMetaData_02M_CIS52299B(),
                   new CswUpdateMetaData_02M_CIS52299D(),                                      
                   new CswUpdateMetaData_02M_CIS52296A(),
                   new CswUpdateMetaData_02M_CIS51811A(),
                   new CswUpdateMetaData_02M_Case52297B()
                };
        } // _MetaDataScripts()
        ...
        public Collection<CswUpdateSchemaTo> _SchemaScripts()
        {
            return new Collection<CswUpdateSchemaTo>
                ...
                // new CswUpdateSchema_02M_CISXXXXX(),
                   ...
                   new CswUpdateSchema_02M_CIS52299E(),
                   new CswUpdateSchema_02M_CIS52296B(),
                   new CswUpdateSchema_02M_CIS53049(),
                   new CswUpdateSchema_02M_CIS52300B()
                };
        } // _SchemaScripts()
