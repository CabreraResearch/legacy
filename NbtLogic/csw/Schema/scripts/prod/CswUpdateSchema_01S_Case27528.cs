...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswUpdateSchema_01S_Case27528 : CswUpdateSchemaTo
    {
        public override void update()
        {
            ...
            CswNbtMetaDataObjectClass InvGrpPermOc = _CswNbtSchemaModTrnsctn.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.InventoryGroupPermissionClass );
            ...
            if( null != DefaultInventoryGroup )
            {
                ...
                CswNbtMetaDataObjectClass LocationOc = _CswNbtSchemaModTrnsctn.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.LocationClass );
        ...
        private CswNbtObjClassWorkUnit _getDefaultWorkUnit()
        {
            ...
            CswNbtMetaDataObjectClass WorkUnitOc = _CswNbtSchemaModTrnsctn.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.WorkUnitClass );
        ...
        private CswNbtObjClassInventoryGroup _getInventoryGroup( string Name )
        {
            ...
            CswNbtMetaDataObjectClass InvGrpOc = _CswNbtSchemaModTrnsctn.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.InventoryGroupClass );
