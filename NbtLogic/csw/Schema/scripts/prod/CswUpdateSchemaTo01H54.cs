...
{
	/// <summary>
	/// Updates the schema to version 01H-54
	/// </summary>
	public class CswUpdateSchemaTo01H54 : ICswUpdateSchemaTo
	{
		private CswNbtSchemaModTrnsctn _CswNbtSchemaModTrnsctn;
		private CswProdUpdtRsrc _CswProdUpdtRsrc = null;

		public CswSchemaVersion SchemaVersion { get { return new CswSchemaVersion( 1, 'H', 54 ); } }
		public string Description { get { return ( _CswProdUpdtRsrc.makeTestCaseDescription( SchemaVersion ) ); } }

		public CswUpdateSchemaTo01H54( CswNbtSchemaModTrnsctn CswNbtSchemaModTrnsctn )
		{
