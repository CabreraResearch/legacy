...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswUpdateSchemaCase25981 : CswUpdateSchemaTo
    {
        public override void update()
        {
            ...
            // case 26529 - don't execute if Lab Safety already exists:
            CswNbtMetaDataNodeType LSTargetNT = _CswNbtSchemaModTrnsctn.MetaData.getNodeType( "Lab Safety" );
            CswNbtMetaDataNodeType LSDesignNT = _CswNbtSchemaModTrnsctn.MetaData.getNodeType( "Lab Safety Checklist" );
            CswNbtMetaDataNodeType LSGroupNT = _CswNbtSchemaModTrnsctn.MetaData.getNodeType( "Lab Safety Group" );
            if( LSTargetNT == null && LSDesignNT == null && LSGroupNT == null )
            {
