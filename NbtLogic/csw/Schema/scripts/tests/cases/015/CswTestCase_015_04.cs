...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_015.Purpose, "Clean up test data" ) ); } }
        ...
        public CswTestCase_015_04( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
