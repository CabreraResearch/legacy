...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_011.Purpose, "Verify tear down" ) ); } }
        ...
        public CswTestCase_011_06( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
