...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_011.Purpose, "Fill test table with data" ) ); } }
        ...
        public CswTestCase_011_02( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
