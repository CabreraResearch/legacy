...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswTestCase_018_01 : CswUpdateSchemaTo
    {
        ...
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_018.Purpose, "build test tables" ) ); } }
