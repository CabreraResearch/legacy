...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_018.Purpose, "inspect and test constraints" ) ); } }
        ...
        public CswTestCase_018_04( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
