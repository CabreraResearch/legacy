...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswTestCase_024_02 : CswUpdateSchemaTo
    {
        ...
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_024.Purpose, "create test data to populate table" ) ); } }
