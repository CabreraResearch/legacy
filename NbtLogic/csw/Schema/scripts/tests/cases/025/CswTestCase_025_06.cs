...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_025.Purpose, "clean up test data" ) ); } }
        ...
        public CswTestCase_025_06( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
