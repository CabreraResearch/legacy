...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public string Description { get { return ( _CswTstCaseRsrc.makeTestCaseDescription( this.GetType().Name, _CswTstCaseRsrc_025.Purpose, "set up test tables" ) ); } }
        ...
        public CswTestCase_025_01( CswSchemaVersion CswSchemaVersion )
        {
