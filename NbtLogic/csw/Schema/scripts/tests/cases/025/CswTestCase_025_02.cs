...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_025.Purpose, "create test data to populate table" ) ); } }
        ...
        public CswTestCase_025_02( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
