...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswTestCase_004_02_013 : ICswUpdateSchemaTo
    {


        private CswNbtSchemaModTrnsctn _CswNbtSchemaModTrnsctn;

        public CswSchemaVersion SchemaVersion { get { return new CswSchemaVersion( 1, 'T', 013 ); } }
        ...
        public CswTestCase_004_02_013( CswNbtSchemaModTrnsctn CswNbtSchemaModTrnsctn )
        {
