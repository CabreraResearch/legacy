...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_020.Purpose, "tear down test data" ) ); } }
