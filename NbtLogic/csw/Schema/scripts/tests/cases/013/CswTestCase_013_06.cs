...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_013.Purpose, "Tear down test table" ) ); } }
        ...
        public CswTestCase_013_06( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
