...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswTestCase_021_01 : ICswUpdateSchemaTo
    {
        ...
        public string Description { get { return ( _CswTstCaseRsrc.makeTestCaseDescription( this.GetType().Name, _CswTstCaseRsrc_021.Purpose, "create tables to be audited" ) ); } }
