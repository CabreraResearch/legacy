...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswTestCase_017_04 : CswUpdateSchemaTo
    {
        ...
        public override string Description { get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_017.Purpose, "inspect and test constraints" ) ); } }
