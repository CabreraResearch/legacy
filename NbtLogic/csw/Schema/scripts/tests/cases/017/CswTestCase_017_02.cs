...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswTestCase_017_02 : ICswUpdateSchemaTo
    {
        ...
        public string Description { get { return ( _CswTstCaseRsrc.makeTestCaseDescription( this.GetType().Name, _CswTstCaseRsrc_017.Purpose, "add test data" ) ); } }
        ...
        public CswTestCase_017_02( CswNbtSchemaModTrnsctn CswNbtSchemaModTrnsctn, CswSchemaVersion CswSchemaVersion, object CswTstCaseRsrc )
        {
