...
namespace ChemSW.Nbt.Schema
{
    ...
    public class CswTestCase_017_05 : CswUpdateSchemaTo
    {
        ...
        public override string Description { get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_017.Purpose, "verify test data tear-down" ) ); } }
