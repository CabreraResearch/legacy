...
namespace ChemSW.Nbt.Schema
{
    ...
    {
        public override string Description { set { ; } get { return ( CswTestCaseRsrc.makeTestCaseDescription( this.GetType().Name, CswTstCaseRsrc_016.Purpose, "Clean up test data" ) ); } }
        ...
        public CswTestCase_016_04( CswSchemaVersion CswSchemaVersion, object CswTstCaseRsc )
        {
