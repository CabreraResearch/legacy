...
namespace ChemSW.Nbt
{
    ...
    public class CswNbtModuleRuleContainers : CswNbtModuleRule
    {
        ...
        public override void OnEnable()
        {
            ...
            _CswNbtResources.Modules.ToggleScheduledRule( NbtScheduleRuleNames.ExpiredContainers, Disabled: false );
            _CswNbtResources.Modules.ToggleScheduledRule( NbtScheduleRuleNames.ContainerReconciliationActions, Disabled: false );
        }
        ...
        public override void OnDisable()
        {
            ...
            _CswNbtResources.Modules.ToggleScheduledRule( NbtScheduleRuleNames.ExpiredContainers, Disabled: true );
            _CswNbtResources.Modules.ToggleScheduledRule( NbtScheduleRuleNames.ContainerReconciliationActions, Disabled: true );
        } // OnDisable()
