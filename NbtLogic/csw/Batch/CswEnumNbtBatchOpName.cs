...
namespace ChemSW.Nbt.Batch
{
    ...
    public sealed class CswEnumNbtBatchOpName : CswEnum<CswEnumNbtBatchOpName>
    {
        ...
        public static readonly CswEnumNbtBatchOpName MailReport = new CswEnumNbtBatchOpName( "MailReport" );
        ...
        public static readonly CswEnumNbtBatchOpName ExpiredContainers = new CswEnumNbtBatchOpName( "ExpiredContainers" );
        public static readonly CswEnumNbtBatchOpName MolFingerprints = new CswEnumNbtBatchOpName( "MolFingerprints" );
        public static readonly CswEnumNbtBatchOpName ContainerReconciliationActions = new CswEnumNbtBatchOpName( "ContainerReconciliationActions" );
