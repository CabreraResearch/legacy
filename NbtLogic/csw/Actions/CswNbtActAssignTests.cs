...
namespace ChemSW.Nbt.Actions
{
    public class CswNbtActAssignTests
    {
        ...
        public Collection<CswPrimaryKey> AssignTest( Collection<CswNbtNodeKey> AliquotNodeKeys, Collection<CswNbtNodeKey> TestNodeKeys )
        {
            ...
            CswNbtMetaDataObjectClass TestObjectClass = _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.TestClass );
            CswNbtMetaDataObjectClass ParameterObjectClass = _CswNbtResources.MetaData.getObjectClass( CswNbtMetaDataObjectClassName.NbtObjectClass.ParameterClass );
