...
namespace ChemSW.Nbt.Actions
{
    public class CswNbtContainerDisposer
    {
        ...
        public CswNbtContainerDisposer( CswNbtResources CswNbtResources, CswNbtContainerDispenseTransactionBuilder ContainerDispenseTransactionBuilder, CswNbtObjClassContainer Container )
        {
