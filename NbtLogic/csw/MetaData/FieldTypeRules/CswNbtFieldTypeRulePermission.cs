...
namespace ChemSW.Nbt.MetaData.FieldTypeRules
{
    ...
    public class CswNbtFieldTypeRulePermission : ICswNbtFieldTypeRule
    {
        ...
        public CswNbtFieldTypeRulePermission( CswNbtFieldResources CswNbtFieldResources )
        {
        ...
        {
            Collection<CswNbtFieldTypeAttribute> ret = _CswNbtFieldTypeRuleDefault.getAttributes( CswEnumNbtFieldType.Permission );
            ret.Add( new CswNbtFieldTypeAttribute( _CswNbtFieldResources.CswNbtResources )
                {
                    OwnerFieldType = CswEnumNbtFieldType.Permission,
            ...
            ret.Add( new CswNbtFieldTypeAttribute( _CswNbtFieldResources.CswNbtResources )
            {
                ...
                AttributeFieldType = CswEnumNbtFieldType.Permission
            } );
            return ret;
        }
