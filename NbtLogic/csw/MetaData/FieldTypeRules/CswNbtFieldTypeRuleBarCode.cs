...
namespace ChemSW.Nbt.MetaData.FieldTypeRules
{
    ...
    public class CswNbtFieldTypeRuleBarCode : ICswNbtFieldTypeRule
    {
        ...
        public CswNbtFieldTypeRuleBarCode( CswNbtFieldResources CswNbtFieldResources, ICswNbtMetaDataProp MetaDataProp )
        {
            ...
            BarcodeSubField = new CswNbtSubField( _CswNbtFieldResources, MetaDataProp, SequenceColumn, CswNbtSubField.SubFieldName.Barcode );
        ...
        public void afterCreateNodeTypeProp( CswNbtMetaDataNodeTypeProp NodeTypeProp )
        {
            ...
            if( ExistingBarcodeCount > 0 )
                throw ( new CswDniException( "Nodetype already has a barcode", "Unable to add barcode node type property because the nodetype (" + NodeTypeProp.NodeType.NodeTypeId.ToString() + ") already has a barcode" ) );
