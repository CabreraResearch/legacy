...
namespace ChemSW.Nbt.MetaData.FieldTypeRules
{
    ...
    public class CswNbtFieldTypeRuleNodeTypePermissions : ICswNbtFieldTypeRule
    {
        ...
        public CswNbtFieldTypeRuleNodeTypePermissions( CswNbtFieldResources CswNbtFieldResources, ICswNbtMetaDataProp MetaDataProp )
        {
            ...
            ValueSubField = new CswNbtSubField( _CswNbtFieldResources, MetaDataProp, CswNbtSubField.PropColumn.ClobData, CswNbtSubField.SubFieldName.Value )
                                {
                                    FilterModes = CswNbtPropFilterSql.PropertyFilterMode.Contains |
